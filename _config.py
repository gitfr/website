...
blog.description = "Projet pour la promotion du bien et la destruction du mal"

## blog_timezone -- the timezone that you normally write your blog posts from
blog.timezone = "Europe/Paris"

## blog_posts_per_page -- Blog posts per page
blog.posts_per_page = 8
...
filters.syntax_highlight.preload_styles = ["murphy","tango"]
#### Custom blog index ####
